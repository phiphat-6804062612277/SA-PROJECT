...
import { Search, Ban, Trash2, Store, Users, Package, ExternalLink, MessageCircle } from 'lucide-react';
...
// จัดการผู้ใช้และร้านค้า (Users & Stores): แบนผู้ซื้อ-ผู้ขาย / แบนร้านค้า / ลบสินค้า / เริ่มแชตกับผู้ใช้
export default function AdminUsersPage() {
  ...
  return (
    <div className="bg-[#dcf0f1] min-h-screen pb-6">
      <PageHeader title="ผู้ใช้ & ร้านค้า" />
